...
export const dungeons: Dungeon[] = [
  ...
  // ========== 高級（Lv50-100）- 火山クレーター：炎系 ==========
  {
    ...
    eliteChance: 0.15,
    namedChance: 0.05,
    lootWeights: { common: 0.53, rare: 0.33, epic: 0.1, legendary: 0.03, mythic: 0.01, 'mythic+': 0.003 },
    chestLootWeights: { common: 0.48, rare: 0.33, epic: 0.13, legendary: 0.04, mythic: 0.02, 'mythic+': 0.006 },
    chestChance: 0.12,
  ...
  // ========== 高級（Lv60-110）- 凍土：氷系 ==========
  {
    ...
    eliteChance: 0.17,
    namedChance: 0.06,
    lootWeights: { common: 0.48, rare: 0.35, epic: 0.13, legendary: 0.03, mythic: 0.015, 'mythic+': 0.004 },
    chestLootWeights: { common: 0.43, rare: 0.35, epic: 0.16, legendary: 0.05, mythic: 0.02, 'mythic+': 0.006 },
    chestChance: 0.13,
  ...
  // ========== 高級（Lv70-120）- 悪魔の塔：複合攻撃 ==========
  {
    ...
    eliteChance: 0.16,
    namedChance: 0.06,
    lootWeights: { common: 0.5, rare: 0.34, epic: 0.11, legendary: 0.03, mythic: 0.015, 'mythic+': 0.004 },
    chestLootWeights: { common: 0.46, rare: 0.34, epic: 0.13, legendary: 0.05, mythic: 0.02, 'mythic+': 0.006 },
    chestChance: 0.13,
  ...
  // ========== 最高難易度（Lv150-300）- 呪われた大聖堂：状態異常地獄 ==========
  {
    ...
    eliteChance: 0.2,
    namedChance: 0.08,
    lootWeights: { common: 0.4, rare: 0.38, epic: 0.16, legendary: 0.04, mythic: 0.02, 'mythic+': 0.008 },
    chestLootWeights: { common: 0.36, rare: 0.38, epic: 0.18, legendary: 0.05, mythic: 0.03, 'mythic+': 0.01 },
    chestChance: 0.14,
  ...
  // ========== 最高難易度（Lv200-350）- 深淵の奈落：複合耐性 ==========
  {
    ...
    eliteChance: 0.24,
    namedChance: 0.12,
    lootWeights: { common: 0.35, rare: 0.4, epic: 0.18, legendary: 0.05, mythic: 0.025, 'mythic+': 0.01 },
    chestLootWeights: { common: 0.32, rare: 0.4, epic: 0.2, legendary: 0.06, mythic: 0.035, 'mythic+': 0.012 },
    chestChance: 0.15,
  ...
  // ========== 最高難易度（Lv250-400）- 魔晶の祭壇：魔法防御高 ==========
  {
    ...
    eliteChance: 0.22,
    namedChance: 0.1,
    lootWeights: { common: 0.37, rare: 0.39, epic: 0.17, legendary: 0.05, mythic: 0.025, 'mythic+': 0.01 },
    chestLootWeights: { common: 0.34, rare: 0.39, epic: 0.19, legendary: 0.07, mythic: 0.04, 'mythic+': 0.014 },
    chestChance: 0.14,
  ...
  // ========== 伝説級（Lv350-550）- 竜の巣：竜族支配 ==========
  {
    ...
    eliteChance: 0.28,
    namedChance: 0.15,
    lootWeights: { common: 0.3, rare: 0.4, epic: 0.2, legendary: 0.06, mythic: 0.03, 'mythic+': 0.015 },
    chestLootWeights: { common: 0.28, rare: 0.4, epic: 0.21, legendary: 0.08, mythic: 0.05, 'mythic+': 0.018 },
    chestChance: 0.16,
  ...
  // ========== 伝説級（Lv400-650）- 次元の狭間：複合防御 ==========
  {
    ...
    eliteChance: 0.3,
    namedChance: 0.18,
    lootWeights: { common: 0.28, rare: 0.4, epic: 0.22, legendary: 0.07, mythic: 0.035, 'mythic+': 0.018 },
    chestLootWeights: { common: 0.26, rare: 0.4, epic: 0.23, legendary: 0.08, mythic: 0.06, 'mythic+': 0.02 },
    chestChance: 0.17,
  ...
  // ========== 究極難易度（Lv800-1000）- 虚無の核心：すべてを無効化 ==========
  {
    ...
    levelRange: [800, 1000],
    prereq: 'dimensional-rift',
    tierWeights: { normal: 0.3, elite: 0.35, named: 0.25, boss: 0.1 },
    eliteChance: 0.32,
    namedChance: 0.2,
    lootWeights: { common: 0.2, rare: 0.35, epic: 0.25, legendary: 0.12, mythic: 0.05, 'mythic+': 0.03 },
    chestLootWeights: { common: 0.18, rare: 0.35, epic: 0.26, legendary: 0.13, mythic: 0.055, 'mythic+': 0.035 },
    chestChance: 0.2,
